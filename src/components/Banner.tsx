  ...
  return (
    <section className="w-full bg-gray-100 py-8 md:py-16 px-2 md:px-0">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        {/* Left: Text Content */}
        <div className="flex-1 min-w-[260px] md:min-w-[340px] lg:min-w-[420px] animate-fade-in-up" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
          ...
          <div className="flex md:justify-start justify-center">
            <Button
              type="primary"
              size="large"
              className="flex items-center !bg-orange-600 hover:!bg-orange-700 !transition-all !px-10 animate-fade-in-up"
        ...
        <div className="flex-1 flex items-center justify-center relative w-full min-h-[260px] md:min-h-[340px]">
          <img src={bannerImg} alt="Banner" className="w-full h-full object-cover animate-zoom-float" style={{ animationDelay: '0.2s', animationFillMode: 'both' }} />
        </div>
      </div>
    </section>
  );
